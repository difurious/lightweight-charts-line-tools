import { CirclePaneView } from '../views/pane/circle-pane-view';

import { ChartModel } from './chart-model';
import { LineTool, LineToolPoint } from './line-tool';
import { CircleToolOptions, LineToolType } from './line-tool-options';
import { UTCTimestamp } from './time-data';

export class LineToolCircle extends LineTool<'Circle'> {
	protected override readonly _toolType: LineToolType = 'Circle';

	public constructor(model: ChartModel, options: CircleToolOptions, points: LineToolPoint[] = []) {
		super(model, options, points);
		this._setPaneViews([new CirclePaneView(this, model)]);
	}
